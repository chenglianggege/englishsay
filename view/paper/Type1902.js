...
import {
    View, Text, StyleSheet, Image, Platform, TouchableOpacity,Alert, ScrollView, Modal, TextInput
} from 'react-native';
...
// 话题简述，根据提示说一段话，提示可以是一段文字、图片和音频，先播放音频后准备答题
export default class Type1902 extends Component {
    constructor(props) {
        super(props);
        console.log(this.props)
        this.state = {info_idx: 0, item_idx: 0,answerArr: [],loading: false,text1:'',text2:'',text3:'',text4:'',text5:'',attention:''}
    }
    ...
    async _starting () {
        ...
        for (let info_idx = 0; info_idx < question.info.length; info_idx ++){
            ...
            if(info_idx === 0){
                for (let item_idx = 0; item_idx < 5; item_idx ++){
